...
class DataExtractor:
    ...
    def retrieve_pdf_data(self, pdf_link):
        try:
            ...
            print("Error while retrieving data from the PDF:", error)
            return None
...
class DataCleaning:
    ...
    def clean_card_data(self, df):
        # Perform data cleaning operations on the card data DataFrame
...
pdf_link = 'https://example.com/path/to/pdf.pdf'
...
if cleaned_card_data is not None:
    ...
    print("Failed to clean the card data.")

# Upload cleaned card data to the database
card_table_name = 'dim_card_details'
connector.upload_to_db(cleaned_card_data, card_table_name)

# Extract data from the database
extracted_data = connector.extract_data(card_table_name)
if extracted_data:
